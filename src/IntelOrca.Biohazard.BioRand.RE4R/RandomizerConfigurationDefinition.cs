...
namespace IntelOrca.Biohazard.BioRand.RE4R
{
    internal static class Re4rRandomizerConfigurationDefinition
    {
        public static RandomizerConfigurationDefinition Create(EnemyClassFactory enemyClassFactory, bool beta)
        {
            ...
            group.Warning = "The Separate Ways DLC is currently required for the randomizer to function correctly.";
            ...
            group.Items.Add(new GroupItem()
            {
                Id = "extra-hiding-lockers",
                Label = "Extra Hiding Lockers",
                Description = "Whether to add additional lockers that Ashley can hide in.",
                Type = "switch",
                Default = true
            });
            ...
            group.Items.Add(new GroupItem()
            {
                Id = "gimmicks-traps",
                Label = "Traps",
                Description = "The amount of bear traps, and trip wires in the randomizer. Random events override any nearby traps.",
                Type = "percent",
                Min = 0,
                Max = 1,
                Step = 0.01,
