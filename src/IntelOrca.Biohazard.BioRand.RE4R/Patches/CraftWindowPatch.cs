...
namespace IntelOrca.Biohazard.BioRand.RE4R.Patches
{
    internal class CraftWindowPatch
    {
        ...
        public void Apply()
        {
            ...
            var craftItemModelParamData = FileRepository.GetGameFileData(templateCraftItemModel)!;
            foreach (var item in itemModels)
            {
            FileRepository.SetGameFileData(templateCraftItemModel, craftItemModelParamData);
            var craftItemModelParamPath = $"natives/stm/_chainsaw/appsystem/prefab/gui/ingameshop/itemmodel/craftitemmodel_{item}.pfb.17";
            FileRepository.SetGameFileData(craftItemModelParamPath, craftItemModelParamData);
            }
